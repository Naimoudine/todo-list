    ...
    <div class="m-6 flex gap-16">
      ...
      <div class="h-fit">
        ...
        <form action="" class="hidden">
          ...
          <button class="text-white" type="submit" @click.prevent="(e) => hanldeCreateList(e)"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 21"><g fill="none" fill-rule="evenodd" stroke="white" stroke-linecap="round" stroke-linejoin="round" transform="translate(2 2)"><circle cx="8.5" cy="8.5" r="8"/><path d="m5.5 9.5l2 2l5-5"/></g></svg></button>
          <button @click.prevent="(e) => handleCancel(e)"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 21"><g fill="none" fill-rule="evenodd" stroke="white" stroke-linecap="round" stroke-linejoin="round" transform="translate(2 2)"><circle cx="8.5" cy="8.5" r="8"/><path d="m5.5 5.5l6 6m0-6l-6 6"/></g></svg></button>
        </form>
      </div>
    </div>
  </main>
